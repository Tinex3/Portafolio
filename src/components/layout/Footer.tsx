      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            &copy; {new Date().getFullYear()} {profile.shortName} · Disponible para roles Full Stack / Backend / IoT
          </p>
          ...
          <nav aria-label="Redes sociales" className="flex items-center gap-2">
            ...
            <a
              ...
              aria-label="GitHub de Benjamin Riquelme (se abre en pestaña nueva)"
              className="flex min-h-[44px] min-w-[44px] items-center justify-center text-gray-600 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn de Benjamin Riquelme (se abre en pestaña nueva)"
              className="flex min-h-[44px] min-w-[44px] items-center justify-center text-gray-600 dark:text-gray-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" focusable="false">
